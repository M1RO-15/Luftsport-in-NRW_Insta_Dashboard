...
with tab_insta:
    if not df_insta.empty:
        ...
        with row2_col1:
            ...
            fig_win.update_traces(textposition='inside', insidetextanchor='start', textfont_color='white', textangle=180)
            ...
            # Text weiß, 90 Grad gedreht, links im Balken
            fig_loss.update_traces(textposition='inside', insidetextanchor='start', textfont_color='white', textangle=-180)
